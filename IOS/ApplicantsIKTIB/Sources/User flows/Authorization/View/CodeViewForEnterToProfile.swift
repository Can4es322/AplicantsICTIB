...
var body: some View {
        VStack {
            ...
            NavigationLink(destination: MainView(), isActive: $loginData.agreeCode) {
                Button {
                    Task {
...
struct CodeViewForEnterToProfile_Previews: PreviewProvider {
    static var previews: some View {
        CodeViewForEnterToProfile(phoneNumber: "89289672932", id: "123")
    }
}
